...
app.service('userService',function($http){
	...
	//增加 
	this.add=function(entity,inputCode){
		return  $http.post('/user/add.do?inputCode='+inputCode,entity );
	}
	//修改 
	...
	//发送验证码
	this.createAndSendSmsCode = function(phone){
		return $http.get('/user/createAndSendSmsCode.do?phone='+phone)
	}
