...
app.controller('contentController' ,function($scope,$controller   ,contentService,uploadService,contentCategoryService){	
	...
	$scope.reloadList = function(){
		$scope.searchContent($scope.paginationConf.currentPage,$scope.paginationConf.itemsPerPage);
	}
	
	$scope.contentSearch = {};
	$scope.searchContent = function(pageIndex,pageSize){
		contentService.searchContent(pageIndex,pageSize,$scope.contentSearch).success(
			function(response){
