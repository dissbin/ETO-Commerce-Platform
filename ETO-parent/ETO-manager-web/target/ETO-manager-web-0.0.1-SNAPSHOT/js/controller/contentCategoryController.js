...
app.controller('contentCategoryController' ,function($scope,$controller   ,contentCategoryService){	
	...
	$scope.reloadList = function(){
		$scope.searchContentCategory($scope.paginationConf.currentPage,$scope.paginationConf.itemsPerPage);
		
	}
	$scope.contentCategorySearch = {};
	$scope.searchContentCategory = function(pageIndex,pageSize){
		contentCategoryService.searchContentCategory(pageIndex,pageSize,$scope.contentCategorySearch).success(
			function(response){
